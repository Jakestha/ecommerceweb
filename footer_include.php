            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-about">
                        <img src="assets/images/ecommerce-logo.png" class="footer-logo" alt="Footer Logo" width="200" height="25">
                        <p>Praesent dapibus, neque id cursus ucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. </p>

                        <div class="widget-call">
                            <i class="icon-phone"></i>
                            Got Question? Call us 24/7
                            <a href="tel:#">+977 9841515155</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-space">
                        ...
                        <ul class="widget-list">
                            ...
                            <li><a href="product.php">Productss</a></li>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-copywrite">
                ...
                <p class="footer-copyright">Copyright © 2022 Ecommerce. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</footer>