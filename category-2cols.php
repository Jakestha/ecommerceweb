    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
                <div class="container">
                    <h1 class="page-title">Products<span>Grid 2 </span></h1>
                </div><!-- End .container -->
            </div><!-- End .page-header -->
                            ...
                            <div class="toolbox">
                                ...
                                <div class="toolbox-right">
                                    ...
                                    <div class="toolbox-layout">
                                        <a href="category-list.php" class="btn-layout">
                                        ...
                                        <a href="category-2cols.php" class="btn-layout active">
                                        ...
                                        <a href="category.php" class="btn-layout">
                                            <svg width="16" height="10">
                                                <rect x="0" y="0" width="4" height="4" />
                                                <rect x="6" y="0" width="4" height="4" />
                                        ...
                                        <a href="category-4cols.php" class="btn-layout">
